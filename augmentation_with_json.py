...
class DataAugmentForObjectDetection:
    def __init__(self, rotation_rate=0.5, max_rotation_angle=180, change_light_rate=0.5, change_color_rate=0.5,
                 ...
                 is_addNoise=True, is_changeLight=True, is_changeColor=True, is_random_point=True,
                 is_shift_pic_bboxes=True,
                 is_filp_pic_bboxes=True, is_rotate_img_bbox=True):
        # 配置各个操作的属性
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default="D:/wy/Temporary/new_img_200/")
    parser.add_argument('--save_img_path', type=str, default="D:/wy/Temporary/tmp/")
    parser.add_argument('--source_json_path', type=str, default="C:/Users/admin/Desktop/json/")
    parser.add_argument('--save_json_path', type=str, default="C:/Users/admin/Desktop/img/")
